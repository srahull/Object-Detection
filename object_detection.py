...
import cv2
print(tf.__version__,"tf")  # for Python 3
print('PIL',PIL.__version__)
import keras
print('PIL',keras.__version__)
#%matplotlib inline
...
with tf.Session() as test_a: #  tf.compat.v1.Session()
...
def iou(box1, box2):
    ...
    inter_area = max(inter_height, 0)*max(inter_height, 0)#inter_width*inter_height
...
def yolo_eval(yolo_outputs, image_shape = (3024., 4032.), max_boxes=10, score_threshold=.6, iou_threshold=.5):
    #(720., 1280.), max_boxes=10, score_threshold=.6, iou_threshold=.5):
    """
...
anchors = read_anchors("/Users/rahulsharma/Downloads/jovyan/work/week3/Car detection for Autonomous Driving/model_data/yolo_anchors.txt")
